        ...
        <div className="  absolute z-10 w-full text-white ">
            <div className="px-4 py-5 mx-auto sm:max-w-2xl md:max-w-full lg:max-w-screen-2xl md:px-24 lg:px-8">
                <div className="relative flex items-center justify-between">
                    ...
                    <ul className="flex items-center hidden space-x-8 lg:flex">
                        <li>
                            <Scroll
                                ...
                                title="Our product"
                                className="font-medium cursor-pointer tracking-wide text-white transition-colors duration-200 hover:text-teal-accent-400 hover:text-[#D65A31]"
                            >
                                About Me
                            </Scroll>
                        </li>
                    ...
                    <div className="flex items-center hidden space-x-8 lg:flex z-30 relative"></div>
