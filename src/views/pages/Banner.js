...
function Banner() {
    return (
        <section className="container py-6 bg-[#c4c4c4] dark:text-coolGray-50 mt-28 rounded-lg sm:w-[70%]   ">
            <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                ...
                <div className="flex items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-col lg:flex-row  lg:ml-4 lg:mt-0  lg:justify-end">
                    <button className="inline-flex items-center third-button">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            className="fill-current w-7 h-7 dark:text-coolGray-900"
                        >
