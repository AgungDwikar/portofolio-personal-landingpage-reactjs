        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 ">
            <div className="grid gap-10 lg:grid-cols-2">
                <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg text-[#f4f4f4]">
                    <div className="flex justify-center mb-4 z-10 absolute lg:flex lg:mt-0 lg:-mx-2 flex-col w-7 h-auto gap-8">
                        <a
                            href="# "
                            className="mx-2 text-red-600 h-9 mt-5 transition-colors duration-200 transform dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300"
                            aria-label="Reddit"
                        >
                            <svg
